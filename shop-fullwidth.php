...
<html lang="en">
  ...
  <body>
        ...
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="breadcrumb-title">Shop Fullwidth</h2>
    ...
    <!-- Shop Area-->
    <div class="shop-area shop-fullwidth">
      <div class="container">
        <div class="row g-4 g-lg-5">
          ...
          <div class="col-12 col-sm-6 col-lg-4">
            <div class="card shop-card">
              ...
              <div class="product-meta d-flex align-items-center justify-content-between p-4">
                <div class="product-name">
                  <h6>Bonsai Tree</h6>
                  <h6 class="price mb-0">$11.45<span>$16.78</span></h6>
                </div>
                <div class="product-add-to-cart">
                  <!-- Add To Cart--><a href="#"><i class="bi bi-cart"></i></a>
                </div>
          ...
          <div class="col-12 col-sm-6 col-lg-4">
            <div class="card shop-card">
              ...
              <div class="product-meta d-flex align-items-center justify-content-between p-4">
                <div class="product-name">
                  <h6>iPad</h6>
                  <h6 class="price mb-0">$300.98<span>$400.63</span></h6>
                </div>
                <div class="product-add-to-cart">
                  <!-- Add To Cart--><a href="#"><i class="bi bi-cart"></i></a>
                </div>
          ...
          <div class="col-12 col-sm-6 col-lg-4">
            <div class="card shop-card">
              <div class="product-img-wrap"><img class="card-img-top" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop9.jpg" alt="">
                <!-- Love Products--><a class="love-product" href="#" data-bs-toggle="tooltip" data-bs-placement="right" title="Like"><i class="bi bi-heart"></i></a>
              </div>
              <div class="product-meta d-flex align-items-center justify-content-between p-4">
                <div class="product-name">
                  <h6>Leather Shoe</h6>
                  <h6 class="price mb-0">$76.38</h6>
                </div>
                <div class="product-add-to-cart">
                  <!-- Add To Cart--><a href="#"><i class="bi bi-cart"></i></a>
                </div>
