        ...
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="breadcrumb-title">Portfolio Details Three</h2>
      ...
      <div class="container">
        <div class="row align-items-end">
          ...
          <div class="col-12 col-sm-4 col-lg-6">
            <div class="text-sm-end mb-80"><a class="btn btn-info rounded-pill" href="#">Live Demo</a></div>
          </div>
        </div>
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="mb-5">
              <h3>Date:</h3>
              <p class="mb-0">17 Oct 2022</p>
            </div>
            <div class="mb-5">
              <h3>Client:</h3>
              <p class="mb-0">Enam Alamin</p>
            </div>
            <div class="mb-5">
              <h3>Budget:</h3>
              <p class="mb-0">$1200</p>
            ...
            <div class="project-details-content mb-5">
              <h5>Summary:</h5>
              <p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there.</p>
            </div>
            <div class="project-details-content mb-5">
              <h5>Mission:</h5>
            ...
            <div class="project-share-info"><a href="#"><i class="bi bi-facebook"></i></a><a href="#"><i class="bi bi-twitter"></i></a><a href="#"><i class="bi bi-linkedin"></i></a><a href="#"><i class="bi bi-slack"></i></a></div>
          </div>
          <div class="col-12 col-md-8">
            <div class="project-details-shots mt-5 mt-md-0">
              <div class="row saasbox-portfolio-filter g-4">
                <!-- Project Image -->
                <div class="col-12 col-sm-6 portfolio-item">
                  <div class="project-img"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p10.jpg" alt=""></div>
                </div>
                <!-- Project Image -->
                <div class="col-12 col-sm-6 portfolio-item">
                  <div class="project-img"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p13.jpg" alt=""></div>
                </div>
                <!-- Project Image -->
                <div class="col-12 col-sm-6 portfolio-item">
                  <div class="project-img"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p11.jpg" alt=""></div>
                </div>
                <!-- Project Image -->
                <div class="col-12 col-sm-6 portfolio-item">
                  <div class="project-img"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p14.jpg" alt=""></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="related-project-area">
      <div class="container">
        ...
        <div class="related-project-slide">
          <!-- Single Slide -->
          <div>
            <div class="single-portfolio-area border"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p18.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p18.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Slide -->
          <div>
            <div class="single-portfolio-area border"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p17.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p17.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Slide -->
          <div>
            <div class="single-portfolio-area border"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p16.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p16.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Slide -->
          <div>
            <div class="single-portfolio-area border"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p15.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p15.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
        </div>
