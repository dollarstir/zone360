    ...
    <div class="saasbox-blog-area">
      <div class="container">
        <div class="row justify-content-center justify-content-md-between">
          <div class="col-12 col-md-7"><img class="rounded mb-4 mb-lg-5" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog20.jpg" alt="">
              ...
              <ol class="ps-0 list-unstyled">
                ...
                <li class="single-comment">
                  <div class="comment-content d-flex">
                    <div class="comment-author"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/t4.png" alt="author"></div>
