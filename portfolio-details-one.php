...
<html lang="en">
  ...
  <body>
        ...
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="breadcrumb-title">Portfolio Details One</h2>
    ...
    <div class="portfolio-details-area portfolio-content">
      <div class="container">
        ...
        <div class="row justify-content-center">           
          <div class="col-12">
            <div class="project-details-shots mb-80"><img class="w-100 rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p19.jpg" alt=""></div>
          </div>
          <div class="col-12 col-md-10">
            <div class="project-details-content mb-80">
              ...
              <p class="mb-0">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quia maiores commodi nulla quidem quos ex natus aliquid dicta laboriosam temporibus, cum voluptate veritatis numquam similique perferendis nesciunt, quo maxime quis voluptates!</p>
            </div>
          </div>
          <div class="col-12 col-md-10">
            <div class="project-share-info"><a href="#"><i class="bi bi-facebook"></i></a><a href="#"><i class="bi bi-twitter"></i></a><a href="#"><i class="bi bi-linkedin"></i></a><a href="#"><i class="bi bi-slack"></i></a><a href="#"><i class="bi bi-youtube"></i></a></div>
          </div>
        </div>
      </div>
    </div>
