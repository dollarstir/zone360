...
<html lang="en">
  ...
  <body>
        ...
        <div class="row h-100 align-items-center justify-content-between">
          ...
          <div class="col-12 col-sm-10 col-md-6">
            <div class="welcome-content">
              ...
              <h2 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">Awesome <br> Creative Agency.</h2>
    ...
    <div class="cool-facts-wrapper">
      <!-- Background Image -->
      <div class="cta-background-image"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/core-img/wm.png" alt=""></div>
      <!-- Circle Animation -->
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-10 col-md-9 col-lg-8">
            <div class="section-heading text-center">
              ...
              <h2>Awesome stunning smart &amp; dynamic feature for your website.</h2>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="tab--area">
              <ul class="nav nav-tabs" id="saasboxTab" role="tablist">
                <li class="nav-item"><a class="nav-link active" id="tab--1" data-bs-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="true">Design &amp; Development</a></li>
                <li class="nav-item"><a class="nav-link" id="tab--2" data-bs-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false">Digital Marketing</a></li>
                <li class="nav-item"><a class="nav-link" id="tab--3" data-bs-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false">Business Solution</a></li>
              </ul>
              <div class="tab-content" id="saasboxTabContent">
                  ...
                  <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-sm-9 col-md-6">
                      <div class="tab--text mt-3 mt-lg-5">
                        ...
                        </div><span class="d-block fz-12">Clients Satisfaction Rate: 90%</span>
                      </div>
                    </div>
                    <div class="col-12 col-sm-9 col-md-6">
                      <div class="tab-thumb mt-5 ms-lg-5"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/illustrator/4.png" alt=""></div>
                    </div>
                  </div>
                </div>
                <!-- Tab Pane-->
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab--2">
                  <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-sm-9 col-md-6">
                      <div class="tab-thumb mt-5 ms-lg-5"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/illustrator/bg-1.png" alt=""></div>
                    </div>
                  </div>
                </div>
                <!-- Tab Pane-->
                <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab--3">
                  <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-sm-9 col-md-6">
                      <div class="tab-thumb mt-5 ms-lg-5"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/illustrator/bg-2.png" alt=""></div>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="saasbox-pricing-plan-area bg-gray pt-120 pb-120">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <div class="pricing-table-switch mb-80 text-center wow fadeInUp" data-wow-duration="1000ms">
              ...
              <div class="col-12 col-sm-9 col-md-7 col-lg-4">
                <div class="card pricing-card monthly-plan mb-30 wow fadeInLeft" data-wow-duration="1000ms">
                  <div class="pricing-heading d-flex justify-content-between mb-5">
                    <div class="price"><span class="badge bg-primary rounded fz-12">Basic</span>
                    ...
                    <div class="price-icon"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/svg-icon/plant2.svg" alt=""></div>
                  </div>
                  ...
                  <div class="pricing-btn"><a class="btn btn-primary" href="cart.html">Choose Plan</a></div>
                </div>
              </div>
              <!-- Single Pricing Plan-->
              <div class="col-12 col-sm-9 col-md-7 col-lg-4">
                <div class="card pricing-card monthly-plan active mb-30">
                  <div class="pricing-heading d-flex justify-content-between mb-5">
                    <div class="price"><span class="badge bg-warning rounded fz-12">Standard</span>
                      <div class="price-quantity">
                    ...
                    <div class="price-icon"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/svg-icon/plant.svg" alt=""></div>
                  </div>
                  <div class="pricing-desc mb-5">
                    <ul class="list-unstyled mb-0">
                      <li>1 Month Usage</li>
                  ...
                  <div class="pricing-btn"><a class="btn btn-warning" href="cart.html">Choose Plan</a></div>
                </div>
              </div>
              <!-- Single Pricing Plan-->
              <div class="col-12 col-sm-9 col-md-7 col-lg-4">
                <div class="card pricing-card monthly-plan mb-30 wow fadeInRight" data-wow-duration="1000ms">
                  <div class="pricing-heading d-flex justify-content-between mb-5">
                    <div class="price"><span class="badge bg-info rounded fz-12">Pro</span>
                      <div class="price-quantity">
                    ...
                    <div class="price-icon"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/svg-icon/saving-money.svg" alt=""></div>
                  </div>
                  <div class="pricing-desc mb-5">
                    <ul class="list-unstyled mb-0">
                      <li>1 Month Usage</li>
                  ...
                  <div class="pricing-btn"><a class="btn btn-info" href="cart.html">Choose Plan</a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="portfolio-wrapper px-3">
          <div class="portfolio-slides">
            <div>
              ...
              <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p1.jpg" alt="">
                <!-- Ovarlay Content -->
                <div class="overlay-content">
                  <div class="portfolio-title">
                    <h6 class="mb-0">Portfolio Title</h6>
                  </div>
                  <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p1.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
                </div>
              </div>
            </div>
            <div>
              <!-- Single Portfolio Area -->
              <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p2.jpg" alt="">
                <!-- Ovarlay Content -->
                <div class="overlay-content">
                  <div class="portfolio-title">
                    <h6 class="mb-0">Apps Redesign</h6>
                  </div>
                  <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p2.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
                </div>
              </div>
            </div>
            <div>
              <!-- Single Portfolio Area -->
              <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p3.jpg" alt="">
                <!-- Ovarlay Content -->
                <div class="overlay-content">
                  <div class="portfolio-title">
                    <h6 class="mb-0">Marketing</h6>
                  </div>
                  <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p3.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
                </div>
              </div>
            </div>
            <div>
              <!-- Single Portfolio Area-->
              <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p4.jpg" alt="">
                <!-- Ovarlay Content -->
                <div class="overlay-content">
                  <div class="portfolio-title">
                    <h6 class="mb-0">eCommerce Solution</h6>
                  </div>
                  <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p4.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
                </div>
              </div>
            </div>
            <div>
    ...
    <div class="mb-120 d-block"></div>
    <!-- Team Area-->
    <div class="saasbox-team-area pt-120 pb-120 bg-gradient">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-sm-9 col-md-7 col-lg-5">
            <div class="section-heading mb-lg-0">
              <h6 class="text-dark">Creative Sailors</h6>
              <h2>Our world class experienced team members.</h2>
              <p class="text-dark">It's crafted with the latest trend of design &amp; coded with all modern approaches.</p><a class="btn btn-light mt-5" href="team.html">View All Members<i class="ms-3 bi bi-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-12 col-lg-7">
                ...
                <div class="col-12 col-sm-6">
                  <div class="card team-card wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="200ms">
                    <div class="card-body px-4 py-5 py-sm-4 py-md-5 text-center">
                      <div class="member-img mb-4 rounded-circle"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/9.jpg" alt=""></div>
                      <h6>L. Sarah</h6>
                      <p class="fz-14">Creative Designer</p>
                      <div class="border"></div><a class="mt-3 btn btn-info btn-minimal fz-14" href="#">Contact with Sarah<i class="bi bi-caret-right-fill"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="card team-card wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="400ms">
                    <div class="card-body px-4 py-5 py-sm-4 py-md-5 text-center">
                      <div class="member-img mb-4 rounded-circle"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/16.jpg" alt=""></div>
                      <h6>H. Riyadh</h6>
                      <p class="fz-14">Full Stack Developer</p>
                      <div class="border"></div><a class="mt-3 btn btn-success btn-minimal fz-14" href="#">Contact with Riyadh<i class="bi bi-caret-right-fill"></i></a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="partner-area">
      ...
      <div class="container">
        <div class="partner-wrapper">
          ...
          <!-- Logo -->
          <div class="partner-logo px-sm-3"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/2.png" alt=""></div>
          <!-- Logo -->
          <div class="partner-logo px-sm-3"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/3.png" alt=""></div>
          <!-- Logo -->
          <div class="partner-logo px-sm-3"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/4.png" alt=""></div>
          <!-- Logo -->
          <div class="partner-logo px-sm-3"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/5.png" alt=""></div>
          <!-- Logo -->
          <div class="partner-logo px-sm-3"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/6.png" alt=""></div>
          <!-- Logo -->
          <div class="partner-logo px-sm-3"><img src="img/partner-img/1.png" alt=""></div>
          <!-- Logo -->
          <div class="partner-logo px-sm-3"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/2.png" alt=""></div>
      ...
      <div class="container">
        <div class="row align-items-end">
          ...
          <div class="col-12 col-sm-4 col-lg-6">
            <div class="text-sm-end"><a class="btn btn-warning mb-80" href="#">View All News</a></div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row justify-content-center g-4 g-md-5 g-lg-4 g-xl-5">
          <div class="col-12 col-sm-9 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog1.jpg" alt=""></a></div>
          ...
          <div class="col-12 col-sm-9 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog2.jpg" alt=""></a>
                <!-- Video-->
          ...
          <div class="col-12 col-sm-9 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog3.jpg" alt=""></a></div>
              <div class="card-body p-4 pb-2">
                <div class="post-meta d-flex align-items-center justify-content-between mb-3"><span class="fz-14"><i class="me-1 bi bi-calendar"></i>12 Sep 2022</span><span class="fz-14"><i class="me-1 bi bi-clock"></i>2 min read</span></div><a class="post-title d-block mb-3" href="blog-details-1.html">Seven ways agency can improve your business.</a>
                <p>It's crafted with the latest trend of design with all modern approaches.</p><a class="btn btn-primary btn-minimal" href="blog-details-1.html">Continue reading...</a>
              </div>
    ...
    <div class="mb-120 d-block"></div>
    <!-- Cool Facts Area-->
    <div class="cta-area pt-120 pb-120 bg-img bg-fixed bg-overlay" style="background-image: url('http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/1.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-10 col-md-8">
            <div class="cta-text">
              <h2 class="mb-4 mb-lg-5 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="200ms">Build a beautiful website very easily within few hours, not a day.</h2><a class="btn btn-warning wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms" href="#">Get started now</a>
            </div>
          </div>
        </div>
      </div>
