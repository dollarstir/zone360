...
<html lang="en">
  ...
  <body>
    ...
    <div class="welcome-area hero4">
      ...
      <div class="hero4-bg-shape"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/core-img/hero-4.png" alt=""></div>
      <!-- Hero Background Shape -->
      <div class="hero4-bg-shape2"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/core-img/hero-4-2.png" alt=""></div>
        ...
        <div class="row h-100 align-items-center">
            ...
            <div class="welcome-content">
              <div class="hero4-slide-controls">
                <div class="hero4-1-slide-wrap">
                  <!-- Single Hero Slide -->
                  <div class="single-hero-slide"><span class="key-quote fw-bold">Try 15 days free trial</span>
                    <h2>Powerful SEO &amp; business service.</h2>
                    <p class="mb-4">It's crafted with the latest trend of design &amp; coded with all modern approaches.</p><a class="btn btn-info" href="#">All Features</a>
                  </div>
                  <!-- Single Hero Slide -->
                  <div class="single-hero-slide"><span class="key-quote fw-bold">Free to use</span>
                    <h2>Easy solutions <br> to make life easier.</h2>
                    <p class="mb-4">It's crafted with the latest trend of design &amp; coded with all modern approaches.</p><a class="btn btn-warning" href="#">Get Quote</a>
                  </div>
                  <!-- Single Hero Slide -->
                  <div class="single-hero-slide"><span class="key-quote fw-bold">Secure &amp; Stable</span>
                    <h2>Awesome, Smart &amp; Creative</h2>
                    <p class="mb-4">It's crafted with the latest trend of design &amp; coded with all modern approaches.</p><a class="btn btn-primary" href="#">Contact Us</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-12 col-sm-8 col-md-6">
            <div class="welcome-thumb ms-5">
              <div class="hero-video-card"><a class="video-play-btn play-button" href="https://www.youtube.com/watch?v=3qyhgV0Zew0"><i class="bi bi-play"></i><span class="video-sonar"></span></a>
                <!-- Shape -->
                <div class="video-shape"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/core-img/hero-3-2.png" alt=""></div>
                <div class="video-card-slides hero4-2-slide-wrap">
                  <div class="rounded"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/9.jpg" alt=""></div>
                  <div class="rounded"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/10.jpg" alt=""></div>
                  <div class="rounded"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/11.jpg" alt=""></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row g-5 g-lg-4">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="card service2-card wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="100ms">
              <div class="card-body">
                <div class="icon"><i class="bi bi-app-indicator"></i></div>
                <h5>Mobile Apps</h5>
                <p class="mb-4">It's crafted with the latest trend of design.</p><a class="btn btn-dark btn-minimal" href="#">Read more</a>
              </div>
            </div>
          </div>
          <!-- Single Service Area -->
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="card service2-card wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="card-body">
                <div class="icon"><i class="bi bi-pie-chart"></i></div>
                <h5>Digital Content</h5>
                <p>It's crafted with the latest trend of design.</p><a class="btn btn-dark btn-minimal" href="#">Read more</a>
              </div>
            </div>
          </div>
          <!-- Single Service Area -->
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="card service2-card wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
              <div class="card-body">
          ...
          <!-- Single Service Area -->
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="card service2-card wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
              <div class="card-body">
