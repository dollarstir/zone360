            ...
            <div class="row g-lg-5 h-100 align-items-center">
              <div class="col-12 col-sm-10 col-md-6">
                ...
                <div class="welcome-content">
                  ...
                  <h2 class="text-white wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Grow up faster with the Saasbox software.</h2>
              ...
              <div class="col-12 col-sm-8 col-md-6">
                <!-- Welcome Thumb -->
                <div class="welcome-thumb ms-xl-5 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms"><img src="img/illustrator/2.png" alt=""></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row g-lg-5 h-100 align-items-center">
              <div class="col-12 col-sm-10 col-md-6">
                ...
                <div class="welcome-content">
                  ...
                  <h2 class="text-white wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Get more revenue with the Saasbox software.</h2>
                  <p class="mb-5 text-white-50 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">It's crafted with the latest trend of design &amp; coded with all modern approaches.      </p>
              ...
              <div class="col-12 col-sm-8 col-md-6">
                <!-- Welcome Thumb -->
                <div class="welcome-thumb ms-xl-5 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/illustrator/3.png" alt=""></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="partner-slides">
              <div>
                <div class="partner-logo"><img src="img/partner-img/1.png" alt=""></div>
              </div>
              <div>
                <div class="partner-logo"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/2.png" alt=""></div>
              </div>
              <div>
                <div class="partner-logo"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/3.png" alt=""></div>
              </div>
              <div>
                <div class="partner-logo"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/4.png" alt=""></div>
              </div>
              <div>
                <div class="partner-logo"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/5.png" alt=""></div>
              </div>
              <div>
                <div class="partner-logo"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/partner-img/6.png" alt=""></div>
              </div>
              <div>
                <div class="partner-logo"><img src="img/partner-img/1.png" alt=""></div>
              </div>
        ...
        <div class="row g-4 g-lg-5 align-items-center">
          <div class="col-12 col-md-7 col-lg-6">
            <div class="aboutUs-content">
              ...
              <h2 class="mb-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">The perfect solution for your saas software.</h2>
          ...
          <div class="col-12 col-md-5 col-lg-6">
            <div class="aboutUs-thumbnail mt-4 mt-md-0 ms-xl-5 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms"><img class="w-100" src="http://preview.designing-world.com/saasbox-v2.0.0/img/illustrator/hero-8.png" alt=""><a class="video-play-btn play-button" href="https://vimeo.com/150991118"><i class="bi bi-play"></i><span class="video-sonar"></span></a></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="faq--area">
      <div class="container">
        <div class="row g-4 g-lg-5 align-items-center">
              ...
              <div class="accordion faq--accordian" id="faqaccordian">
                ...
                <div class="card border-0">
                  <div class="card-header" id="headingOne">
                    <button class="btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">How can I purchased Saasbox?</button>
                  </div>
                ...
                <div class="card border-0">
                  <div class="card-header" id="headingTwo">
                    <button class="btn collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">What are the minimum requirements?</button>
                  </div>
                ...
                <div class="card border-0">
                  <div class="card-header" id="headingThree">
                    <button class="btn collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">What is the regular license?</button>
                  </div>
          ...
          <div class="col-12 col-md-5 col-lg-6">
            <div class="faq--thumbnail ms-xl-5"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/illustrator/3.png" alt=""></div>
          </div>
        </div>
      </div>
    </div>
