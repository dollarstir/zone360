...
<html lang="en">
  ...
  <body>
    ...
    <!-- Breadcrumb Area-->
    <div class="breadcrumb-wrapper bg-img bg-overlay" style="background-image: url('http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/12.jpg');">
    ...
    <div class="bg-gray pt-120 pb-120">
          ...
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <p class="text-dark mb-0 fw-bold">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat sunt, dolorum sint officiis quibusdam illum!</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Enim, consequuntur.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aspernatur vel, exercitationem, commodi id sapiente expedita modi perferendis tenetur eum maxime, possimus eveniet?</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit, amet consectetur adipisicing elit. A quidem autem cum neque commodi aperiam labore.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa fugiat obcaecati excepturi reprehenderit quod non, minus inventore?</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus, architecto ratione numquam quas fugit non impedit!</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, culpa blanditiis?</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tenetur molestiae maxime expedita rerum exercitationem hic qui natus, velit illo.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque eaque iste unde voluptates?</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur, quos libero!</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quidem dignissimos in eveniet quam minus aperiam ipsa!</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem, consequatur fuga rem sed asperiores expedita ab.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias, ad error.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse aliquid voluptate itaque sequi natus quae blanditiis?</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias, esse voluptatum!</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum qui magnam dolorum mollitia, itaque dicta velit?</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
          ...
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
            <div class="card feedback-card border-0 p-2 shadow-sm">
              <div class="card-body p-4 p-md-5">
                ...
                <div class="ratings text-warning mt-4 mb-3 fz-14"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
                <p class="text-dark mb-0 fw-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad quibusdam nesciunt incidunt.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="text-center"><a class="btn btn-primary mt-5" href="#">Load More Reviews</a></div>
      </div>
    </div>
    <!-- Footer Area-->
