...
<html lang="en">
  ...
  <body>
    ...
    <div class="product-details-area product-details-page">
      <div class="container">
        <div class="row g-4 g-lg-5 justify-content-center">
          <div class="col-12 col-md-9 col-lg-6">
            <div class="mb-3 mb-sm-5 position-relative product-details-carousel-wrap">
              <!-- Carousel -->
              <div class="product-details-carousel portfolio-img-zoom">
                <!-- Carousel Item --><a class="rounded" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop1.jpg" title="Item Image 1"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop1.jpg" alt=""></a>
                <!-- Carousel Item --><a class="rounded" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop2.jpg" title="Item Image 2"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop2.jpg" alt=""></a>
                <!-- Carousel Item --><a class="rounded" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop3.jpg" title="Item Image 3"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop3.jpg" alt=""></a>
                <!-- Carousel Item --><a class="rounded" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop4.jpg" title="Item Image 4"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop4.jpg" alt=""></a>
                <!-- Carousel Item --><a class="rounded" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop5.jpg" title="Item Image 5"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop5.jpg" alt=""></a>
                <!-- Carousel Item --><a class="rounded" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop6.jpg" title="Item Image 6"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/shop6.jpg" alt=""></a>
              </div>
            </div>
          </div>
          <!-- Product Description-->
          <div class="col-12 col-md-9 col-lg-6">
            <div class="card product-description-card mb-4 mb-sm-5">
              <h6 class="product-meta-title mb-0 ps-5 py-4">About Product</h6>
              <div class="card-body p-3 p-sm-5">
                <h4 class="mb-3">Bonsai Tree</h4>
                <h3 class="product-price mb-4">$19.23<span>$32.89</span></h3>
                <h6 class="mb-4">36 Product Left                            </h6>
                <p>It's crafted with the latest trend of design &amp; coded with all modern approaches. It's a robust &amp; multi-dimensional usable template. It's crafted with the latest trend of design &amp; coded with all modern approaches.</p>
                <form class="d-flex align-items-end mt-4" action="#">
                  <div class="form-group mb-0">
                    <label class="me-2 mb-2" for="totalQuantity">Quantity</label>
                    <input class="form-control" id="totalQuantity" type="number" min="1" max="12" name="quantity" value="1">
                  </div>
                  <button class="btn btn-primary ms-3" type="submit">Buy Now</button>
                </form>
              </div>
            </div>
          </div>
        ...
        <div class="card product-review-card">
          <h6 class="product-meta-title mb-0 ps-5 py-4">Product Reviews</h6>
          <div class="card-body p-3 p-sm-5 text-center">
            <ul class="ratings-list d-flex align-items-center justify-content-center mb-0 list-unstyled">
              <li class="active"><i class="bi bi-star"></i></li>
              <li class="active"><i class="bi bi-star"></i></li>
              <li class="active"><i class="bi bi-star"></i></li>
              <li class="active"><i class="bi bi-star"></i></li>
              <li class="active"><i class="bi bi-star"></i></li>
            </ul><span>4.89 out of 5.00 (203 reviews)</span>
          </div>
        </div>
      </div>
    </div>
