...
<html lang="en">
  ...
  <body>
        ...
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="breadcrumb-title">Service Standard</h2>
    ...
    <div class="video-area bg-img bg-overlay bg-fixed" style="background-image: url('http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/15.jpg');">
      <div class="container"><a class="video-play-btn play-button" href="https://www.youtube.com/watch?v=3qyhgV0Zew0"><i class="bi bi-play"></i><span class="video-sonar"></span></a></div>
    </div>
    <!-- Cool Facts Area-->
