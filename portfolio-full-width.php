        ...
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="breadcrumb-title">Portfolio Full Width</h2>
      ...
      <div class="container-fluid">
        <div class="row saasbox-portfolio-filter g-3">
          ...
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item branding">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p13.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p13.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Portfolio Area-->
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item branding">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p14.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p14.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Portfolio Area-->
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item design">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p15.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
          ...
          <!-- Single Portfolio Area-->
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item design">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p16.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
          ...
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item marketing">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p17.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
          ...
          <!-- Single Portfolio Area-->
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item marketing">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p18.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
