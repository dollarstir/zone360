        ...
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="breadcrumb-title">Portfolio Details Two</h2>
      ...
      <div class="container">
        ...
        <div class="row g-4 g-lg-5 justify-content-center">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="project-card text-center"><span>01</span>
              <h3>Date:</h3>
              <p class="mb-0">17 Oct 2022</p>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4">
            <div class="project-card text-center"><span>02</span>
              <h3>Client:</h3>
              <p class="mb-0">Enam Alamin</p>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4">
            <div class="project-card text-center"><span>03</span>
              <h3>Project Link:</h3>
              <p class="mb-0"><a href="#" target="_blank">enamalamin.com                        </a></p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="project-details-shots mb-80 mt-5"><img class="rounded" src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p19.jpg" alt=""></div>
          </div>
        </div>
