        ...
        <div class="row h-100 align-items-center">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="breadcrumb-title">Portfolio Standard</h2>
      ...
      <div class="container">
        <div class="row saasbox-portfolio-filter g-4">
          ...
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item marketing">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p5.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p5.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Portfolio Area -->
          <div class="col-12 col-sm-6 col-lg-4 portfolio-item marketing">
            <div class="single-portfolio-area"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p6.jpg" alt="">
              <!-- Ovarlay Content -->
              <div class="overlay-content">
                <div class="portfolio-title">
                  <h6 class="mb-0">Portfolio Title</h6>
                </div>
                <div class="portfolio-links"><a class="portfolio-img-zoom" href="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/p6.jpg"><i class="bi bi-arrows-fullscreen"></i></a><a href="portfolio-details-one.html"><i class="bi bi-link-45deg"></i></a></div>
              </div>
            </div>
          </div>
        </div>
        <div class="load-more-btn text-center mt-70"><a class="btn btn-primary" href="#">Load More</a></div>
      </div>
    </div>
    <!-- Footer Area-->
