    ...
    <div class="saasbox-blog-area blog-card-page">
      <div class="container">
        <div class="row g-4 g-md-5 justify-content-center">
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog2.jpg" alt=""></a></div>
              <div class="card-body p-4 pb-2">
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog3.jpg" alt=""></a>
                <!-- Video-->
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog7.jpg" alt=""></a></div>
              <div class="card-body p-4 pb-2">
                <div class="post-meta d-flex align-items-center justify-content-between mb-3"><span class="fz-14"><i class="me-1 bi bi-calendar"></i>12 Sep 2022</span><span class="fz-14"><i class="me-1 bi bi-clock"></i>2 min read</span></div><a class="post-title d-block mb-3" href="blog-details-1.html">Seven ways agency can improve your business.</a>
                <p>It's crafted with the latest trend of design with all modern approaches.</p><a class="btn btn-primary btn-minimal" href="blog-details-1.html">Continue reading...</a>
              </div>
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog8.jpg" alt=""></a>
                <!-- Video -->
                <div class="video-play-btn"><i class="bi bi-play"></i></div>
              </div>
              <div class="card-body p-4 pb-2">
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog9.jpg" alt=""></a></div>
              <div class="card-body p-4 pb-2">
                <div class="post-meta d-flex align-items-center justify-content-between mb-3"><span class="fz-14"><i class="me-1 bi bi-calendar"></i>12 Sep 2022</span><span class="fz-14"><i class="me-1 bi bi-clock"></i>2 min read</span></div><a class="post-title d-block mb-3" href="blog-details-1.html">Seven ways agency can improve your business.</a>
                <p>It's crafted with the latest trend of design with all modern approaches.</p><a class="btn btn-primary btn-minimal" href="blog-details-1.html">Continue reading...</a>
              </div>
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog10.jpg" alt=""></a></div>
              <div class="card-body p-4 pb-2">
                <div class="post-meta d-flex align-items-center justify-content-between mb-3"><span class="fz-14"><i class="me-1 bi bi-calendar"></i>12 Sep 2022</span><span class="fz-14"><i class="me-1 bi bi-clock"></i>2 min read</span></div><a class="post-title d-block mb-3" href="blog-details-1.html">The reason why everyone love business.</a>
                <p>It's crafted with the latest trend of design with all modern approaches.</p><a class="btn btn-primary btn-minimal" href="blog-details-1.html">Continue reading...</a>
              </div>
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog11.jpg" alt=""></a></div>
              <div class="card-body p-4 pb-2">
                <div class="post-meta d-flex align-items-center justify-content-between mb-3"><span class="fz-14"><i class="me-1 bi bi-calendar"></i>12 Sep 2022</span><span class="fz-14"><i class="me-1 bi bi-clock"></i>2 min read</span></div><a class="post-title d-block mb-3" href="blog-details-1.html">Seven ways agency can improve your business.</a>
                <p>It's crafted with the latest trend of design with all modern approaches.</p><a class="btn btn-primary btn-minimal" href="blog-details-1.html">Continue reading...</a>
              </div>
          ...
          <div class="col-12 col-sm-10 col-md-6 col-lg-4">
            <div class="card blog-card border-0">
              <div class="image-wrap"><a class="d-block" href="blog-details-1.html"><img src="http://preview.designing-world.com/saasbox-v2.0.0/img/bg-img/blog12.jpg" alt=""></a>
                <!-- Video-->
                <div class="video-play-btn"><i class="bi bi-play"></i></div>
              </div>
              <div class="card-body p-4 pb-2">
